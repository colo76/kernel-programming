...
#include <linux/proc_fs.h>  /* Para acceder al /rpco */
...
/* Para leer el contenido del /proc/module_so, recordemos que la idea que idea es tranferir datos hacia el espacio de usuario,
